...
export const AI_HARNESS_EVAL_CASES: AiHarnessEvalCase[] = [
  ...
  c({ id: 'review-queue-01', prompt: '查看当前学生今天到期的复习队列', expectedRoute: 'student_diagnosis', expectedSubIntent: 'review_queue', expectedTools: ['get_student_profile', 'search_learning_records', 'mastery_status', 'get_review_queue'], forbiddenTools: [], hasStudent: true }),
  c({ id: 'review-queue-02', prompt: '小A有哪些待复习知识点？按间隔复习排序', expectedRoute: 'student_diagnosis', expectedSubIntent: 'review_queue', expectedTools: ['resolve_student_reference', 'get_student_profile', 'search_learning_records', 'mastery_status', 'get_review_queue'], forbiddenTools: [], hasStudent: false }),
  c({ id: 'review-queue-03', prompt: '根据到期复习任务设计今天的巩固练习', expectedRoute: 'practice_design', expectedSubIntent: 'review_queue', expectedTools: ['get_student_profile', 'search_learning_records', 'mastery_status', 'get_review_queue'], forbiddenTools: [] }),
  ...
  c({ id: 'knowledge-13', prompt: '总结备课本中的一次函数笔记', expectedRoute: 'knowledge_retrieval', expectedSubIntent: 'resource_search', expectedTools: ['analyze_notebook_context'], forbiddenTools: ['get_student_profile', 'search_learning_records'] }),
  c({ id: 'knowledge-14', prompt: '从 notebook 历史草稿里找课堂导入', expectedRoute: 'knowledge_retrieval', expectedSubIntent: 'resource_search', expectedTools: ['analyze_notebook_context'], forbiddenTools: ['get_student_profile', 'search_learning_records'] }),

  c({ id: 'question-notebook-01', prompt: '列出我收藏的一次函数题目', expectedRoute: 'practice_design', expectedSubIntent: 'question_notebook', expectedTools: ['search_question_notebook'], forbiddenTools: ['get_student_profile', 'search_learning_records'] }),
  c({ id: 'question-notebook-02', prompt: '按“待讲解”分类查看题目收藏', expectedRoute: 'practice_design', expectedSubIntent: 'question_notebook', expectedTools: ['search_question_notebook'], forbiddenTools: ['get_student_profile', 'search_learning_records'] }),

  c({ id: 'book-workspace-01', prompt: '检查一次函数专题讲义的来源健康', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['inspect_teaching_book'], forbiddenTools: ['get_student_profile', 'search_learning_records', 'search_teacher_knowledge'] }),
  c({ id: 'book-workspace-02', prompt: '查看单元备课包的章节页面和内容块状态', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['inspect_teaching_book'], forbiddenTools: ['get_student_profile', 'search_learning_records', 'search_teacher_knowledge'] }),
  c({ id: 'book-renderer-01', prompt: '把这个专题讲义生成 Markdown 预览', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['draft_teaching_book_markdown'], forbiddenTools: ['get_student_profile', 'search_learning_records', 'search_teacher_knowledge'] }),
  c({ id: 'book-renderer-02', prompt: '预览单元备课包的 quiz 和概念图', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['draft_teaching_book_markdown'], forbiddenTools: ['get_student_profile', 'search_learning_records', 'search_teacher_knowledge'] }),
  c({ id: 'book-planner-01', prompt: '规划一次函数专题讲义的章节骨架', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['plan_teaching_book', 'search_teacher_knowledge'], forbiddenTools: ['get_student_profile', 'search_learning_records'] }),
  c({ id: 'book-planner-02', prompt: '做一次来源探索并生成章节大纲', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['plan_teaching_book', 'search_teacher_knowledge'], forbiddenTools: ['get_student_profile', 'search_learning_records'] }),
  c({ id: 'book-health-01', prompt: '刷新专题讲义的来源指纹健康并定位失效块', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['refresh_teaching_book_health'], forbiddenTools: ['get_student_profile', 'search_learning_records', 'search_teacher_knowledge'] }),
  c({ id: 'book-health-02', prompt: '查看讲义知识库漂移和局部失效队列', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['refresh_teaching_book_health'], forbiddenTools: ['get_student_profile', 'search_learning_records', 'search_teacher_knowledge'] }),
  c({ id: 'book-cowriter-01', prompt: '编辑讲义内容块并生成 patch 草稿', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['draft_teaching_book_patch'], forbiddenTools: ['get_student_profile', 'search_learning_records', 'search_teacher_knowledge'] }),
  c({ id: 'book-cowriter-02', prompt: '修改讲义后保留 diff 并支持撤销', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['draft_teaching_book_patch'], forbiddenTools: ['get_student_profile', 'search_learning_records', 'search_teacher_knowledge'] }),
  c({ id: 'book-cowriter-selection-01', prompt: '对讲义选中的一段文字做局部改写，先生成选区 patch', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['draft_teaching_book_selection_patch'], forbiddenTools: ['get_student_profile', 'search_learning_records', 'search_teacher_knowledge'] }),
  c({ id: 'book-cowriter-selection-02', prompt: '对选中的讲义内容自动批注并流式预览', expectedRoute: 'lesson_design', expectedSubIntent: 'book_workspace', expectedTools: ['draft_teaching_book_selection_patch'], forbiddenTools: ['get_student_profile', 'search_learning_records', 'search_teacher_knowledge'] }),
  ...
  c({ id: 'memory-trace-01', prompt: 'show the recent memory trace and tool summary', expectedRoute: 'general_qa', expectedSubIntent: 'memory_trace', expectedTools: ['inspect_memory_trace'], forbiddenTools: noStudentTools }),
  c({ id: 'memory-trace-02', prompt: 'inspect memory evidence without returning the original prompt', expectedRoute: 'general_qa', expectedSubIntent: 'memory_trace', expectedTools: ['inspect_memory_trace'], forbiddenTools: noStudentTools }),
  c({ id: 'memory-summary-01', prompt: 'inspect the editable L2 memory summary', expectedRoute: 'general_qa', expectedSubIntent: 'memory_summary', expectedTools: ['inspect_memory_summary', 'draft_memory_summary'], forbiddenTools: noStudentTools }),
  c({ id: 'memory-summary-02', prompt: 'draft a surface summary from local evidence without writing memory', expectedRoute: 'general_qa', expectedSubIntent: 'memory_summary', expectedTools: ['inspect_memory_summary', 'draft_memory_summary'], forbiddenTools: noStudentTools }),
  c({ id: 'memory-synthesis-01', prompt: 'inspect the L3 cross-surface profile memory', expectedRoute: 'general_qa', expectedSubIntent: 'memory_synthesis', expectedTools: ['inspect_memory_synthesis', 'draft_memory_synthesis', 'inspect_memory_graph', 'inspect_memory_governance'], forbiddenTools: noStudentTools }),
  c({ id: 'memory-synthesis-02', prompt: 'draft a recent memory synthesis from confirmed L2 entries', expectedRoute: 'general_qa', expectedSubIntent: 'memory_synthesis', expectedTools: ['inspect_memory_synthesis', 'draft_memory_synthesis', 'inspect_memory_graph', 'inspect_memory_governance'], forbiddenTools: noStudentTools }),
  c({ id: 'research-01', prompt: 'deep research assistant: build a literature review outline about formative assessment', expectedRoute: 'knowledge_retrieval', expectedSubIntent: 'research_workspace', expectedTools: ['generate_research_outline', 'search_teacher_knowledge'], forbiddenTools: noStudentTools }),
  c({ id: 'research-02', prompt: '生成教研报告研究提纲，列出来源和未知项', expectedRoute: 'knowledge_retrieval', expectedSubIntent: 'research_workspace', expectedTools: ['generate_research_outline', 'search_teacher_knowledge'], forbiddenTools: noStudentTools }),
  c({ id: 'visualization-01', prompt: 'visualize the knowledge graph as a mermaid concept map', expectedRoute: 'lesson_design', expectedSubIntent: 'visualization', expectedTools: ['render_learning_mermaid', 'query_knowledge_graph'], forbiddenTools: noStudentTools }),
  c({ id: 'visualization-02', prompt: '生成知识点关系图并用 Mermaid 展示', expectedRoute: 'lesson_design', expectedSubIntent: 'visualization', expectedTools: ['render_learning_mermaid', 'query_knowledge_graph'], forbiddenTools: noStudentTools }),
];
